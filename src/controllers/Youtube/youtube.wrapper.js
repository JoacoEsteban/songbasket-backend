  ...
  YouTubeAPI: function ({ access_tokens }) {
    ...
    this.Youtubize = (track) => {
      return new Promise((resolve, reject) => {
        handleYtQuery(track, {
            tokenFunction: this.giveMe.current_access_token,
            tokenCycle: this.cycleAccessToken
          })
        ...
        ytGetVideoDetails(id, this.giveMe.current_access_token(), true)
          .then(results => {
            ...
            resolve({
              ...
              id,
              duration: parseDuration(results.items[0].contentDetails.duration)
            })
          })
          .catch(err => {
